...
<div id="tribe-events-content" class="tribe-events-single paddingRight paddingLeft">
...
<?php
	$banner_img_url = get_post_meta($event_id, 'Banner_Image_URL', true);
	if($banner_img_url) {
		echo  '<img id="banner-image" src="'.$banner_img_url.'">';
	}
?>

<script>
	var bannerImgContainer = document.getElementById("single-featured-image-container");
