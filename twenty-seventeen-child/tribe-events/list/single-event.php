...
<div class="tribe-events-event-meta">
	<div class="author <?php echo esc_attr( $has_venue_address ); ?>">
		...
		<div class="tribe-event-schedule-details">
			...
			<?php
                                // $dates = get_post_meta($event_id, 'recurring_dates', false);
                                // if ($dates != null) {
...
<?php
      ...
      if ($ticket_type == 'free') { ?>
        <span><h4 class="free-event" style="text-align: center; margin-top: 5px; font-size: 1.6rem; font-weight: 400; font-weight: bold;">This is a free event.</h4></span>
      <?php } else  {
        $ticket_url = get_field('ticket_url');
        if ($ticket_type == 'reserved') { ?>
         <a href="<?php echo $ticket_url; ?>" class="button event-buy-ticket-button-container buy-ticket-button">RESERVE TICKETS</a>
        <?php } else { ?>
