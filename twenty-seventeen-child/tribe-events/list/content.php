...
<div id="tribe-events-content" class="tribe-events-list">
  ...
  <!-- Events Loop -->
	...
	<?php endif; ?>
        ...
        <!-- Display past events for events & tickets page -->
        <?php
                $eventPage = "/events/";
                $currentPage = $_SERVER['REQUEST_URI'];
                // if($eventPage == $currentPage){
                //         show_past_event("", "1/1/2017", 1);
                // } 
                /*
                else {
                        $category_from_uri = get_category_from_uri($currentPage);
                        show_past_event( $category_from_uri );
                }
                 */
        ?>
